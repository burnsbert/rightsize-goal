...
Return a compact receipt: task ID; conclusion and its supporting evidence; findings, files touched, and checks run; failed approaches; remaining uncertainty; concrete next action with acceptance criteria; the lowest capable tier for follow-through.
