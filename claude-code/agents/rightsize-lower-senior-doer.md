...
Return a concise receipt: task ID; completed or unresolved; findings and files touched; checks run and their results; failed approaches; remaining risks; next useful action. Never claim a check you did not run.
